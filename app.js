...
class GridSystem {
    constructor() {
        ...
        this.playersArr = [
            ...
            this.p4 = new Player({x: 14, y: 10, lable: 5, id: this.extraArr[3], area: "area1", color: "lightblue"}),
            this.p5 = new Player({x: 14, y: 11, lable: 6, id: this.extraArr[4], area: "area1", color: "lightyellow"}),
            this.p6 = new Player({x: 14, y: 12, lable: 7, id: this.extraArr[5], area: "area1", color: "deepskyblue"}),
